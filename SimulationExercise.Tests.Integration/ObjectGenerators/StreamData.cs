...
6831,Ossidi di Azoto,mg_m3,180,BS,Lonato del Garda,false,{(int)(SystemTime.Now().Date - new DateTime(1990,1,1).Date).TotalDays},5035536,615762,45.46375819,10.48078183";
            ...
            yield return new object[]
            {
                ...
                {
                    new InputFileGetDTO(1, "InputFile", bytesInputText, ".csv", Status.Success),
                    new InputFileGetDTO(2, "InputFile", bytesInputText, ".csv", Status.Success)
                },
                ...
                new List<ReadingGetDTO>
                {
                    ...
                    new ReadingGetDTO(11, 2, 12691, "Arsenico", "ng/m³", 560, "Varese v.Copelli", 383, "VA", "Varese", false, new DateTime(2008, 4, 1), SystemTime.Now().Date, 5073728, 486035, "45.8169745", "8.82024911", Status.Success),
                    new ReadingGetDTO(12, 2, 5712, "Ozono", "µg/m³", 510, "Inzago v.le Gramsci", 138, "MI", "Inzago", true, new DateTime(2001, 2, 24), new DateTime(2018, 1, 1), 5043030, 538012, "45.53976956", "9.48689669", Status.Success),
                    new ReadingGetDTO(13, 2, 20488, "Ozono", "µg/m³", 564, "Erba v. Battisti", 279, "MI", "Erba", false, new DateTime(2020, 10, 22), SystemTime.Now().Date, 5072803, 517232, "45.8085738", "9.2217792", Status.Success),
                    new ReadingGetDTO(14, 2, 10043, "Arsenico", "ng/m³", 687, "Ferno v.Di Dio", 215, "VA", "Ferno", false, new DateTime(2006, 11, 29), SystemTime.Now().Date, 5051773, 481053, "45.61924753", "8.75697656", Status.Success),
                    new ReadingGetDTO(15, 2, 6342, "Ossidi di Azoto", "mg/m³", 515, "Pero SS Sempione", 141, "BS", "Pero", true, new DateTime(1986, 12, 10), new DateTime(2018, 7, 30), 5039595, 507028, "45.50985564", "9.08997419", Status.Success),
                    new ReadingGetDTO(16, 2, 6665, "Ossidi di Azoto", "mg/m³", 565, "Cantù v.Meucci", 369, "BS", "Cantù", false, new DateTime(2005, 1, 17), SystemTime.Now().Date, 5064150, 509783, "45.73083728", "9.12573936", Status.Success),
                    new ReadingGetDTO(17, 2, 10270, "Ozono", "µg/m³", 655, "Darfo Boario Terme v. De Amicis", 221, "MI", "Darfo Boario Terme", true, new DateTime(2007, 1, 1), new DateTime(2023, 7, 12), 5080789, 591371, "45.87460256", "10.17736553", Status.Success),
                    new ReadingGetDTO(18, 2, 5507, "Biossido di Azoto", "µg/m³", 504, "Sesto San Giovanni v. Cesare da Sesto", 139, "CO", "Sesto San Giovanni", false, new DateTime(1980, 12, 18), SystemTime.Now().Date, 5042386, 518435, "45.53476819", "9.23610903", Status.Success),
                    new ReadingGetDTO(19, 2, 10035, "Benzene", "µg/m³", 672, "Cornale v.Libertà", 74, "CO", "Cornale", false, new DateTime(2006, 2, 2), SystemTime.Now().Date, 4987406, 493238, "45.04008561", "8.91415717", Status.Success),
                    new ReadingGetDTO(20, 2, 6831, "Ossidi di Azoto", "mg/m³", 657, "Lonato del Garda v.del Marchesino", 180, "BS", "Lonato del Garda", false, new DateTime(1990, 1, 1), SystemTime.Now().Date, 5035536, 615762, "45.46375819", "10.48078183", Status.Success)
                },

                new List<ConsistentReadingGetDTO>
                {
                    new ConsistentReadingGetDTO(1, 1, 12691, "Arsenico", Unit.ng_m3, 383, "VA", "Varese", false, (int)(SystemTime.Now().Date - new DateTime(2008,4,1).Date).TotalDays, 5073728, 486035, "45.8169745", "8.82024911", Status.Success),
                    new ConsistentReadingGetDTO(2, 2, 5712, "Ozono", Unit.µg_m3, 138, "MI", "Inzago", true, (int)(new DateTime(2018,1,1).Date - new DateTime(2001,02,24).Date).TotalDays, 5043030, 538012, "45.53976956", "9.48689669", Status.Success),
                    new ConsistentReadingGetDTO(3, 3, 20488, "Ozono", Unit.µg_m3, 279, "MI", "Erba", false, (int)(SystemTime.Now().Date - new DateTime(2020,10,22).Date).TotalDays, 5072803, 517232, "45.8085738", "9.2217792", Status.Success),
                    new ConsistentReadingGetDTO(4, 4, 10043, "Arsenico", Unit.ng_m3, 215, "VA", "Ferno", false, (int)(SystemTime.Now().Date - new DateTime(2006,11,29).Date).TotalDays, 5051773, 481053, "45.61924753", "8.75697656", Status.Success),
                    new ConsistentReadingGetDTO(5, 5, 6342, "Ossidi di Azoto", Unit.mg_m3, 141, "BS", "Pero", true, (int)(new DateTime(2018,07,30).Date - new DateTime(1986,12,10).Date).TotalDays, 5039595, 507028, "45.50985564", "9.08997419", Status.Success),
                    new ConsistentReadingGetDTO(6, 6, 6665, "Ossidi di Azoto", Unit.mg_m3, 369, "BS", "Cantù", false, (int)(SystemTime.Now().Date - new DateTime(2005,01,17).Date).TotalDays, 5064150, 509783, "45.73083728", "9.12573936", Status.Success),
                    new ConsistentReadingGetDTO(7, 7, 10270, "Ozono", Unit.µg_m3, 221, "MI", "Darfo Boario Terme", true, (int)(new DateTime(2023,07,12).Date - new DateTime(2007,1,1).Date).TotalDays, 5080789, 591371, "45.87460256", "10.17736553", Status.Success),
                    new ConsistentReadingGetDTO(8, 8, 5507, "Biossido di Azoto", Unit.µg_m3, 139, "CO", "Sesto San Giovanni", false, (int)(SystemTime.Now().Date - new DateTime(1980,12,18).Date).TotalDays, 5042386, 518435, "45.53476819", "9.23610903", Status.Success),
                    new ConsistentReadingGetDTO(9, 9, 10035, "Benzene", Unit.µg_m3, 74, "CO", "Cornale", false, (int)(SystemTime.Now().Date - new DateTime(2006,2,2).Date).TotalDays, 4987406, 493238, "45.04008561", "8.91415717", Status.Success),
                    new ConsistentReadingGetDTO(10, 10, 6831, "Ossidi di Azoto", Unit.mg_m3, 180, "BS", "Lonato del Garda", false, (int)(SystemTime.Now().Date - new DateTime(1990,1,1).Date).TotalDays, 5035536, 615762, "45.46375819", "10.48078183", Status.Success),             
                    new ConsistentReadingGetDTO(11, 11, 12691, "Arsenico", Unit.ng_m3, 383, "VA", "Varese", false, (int)(SystemTime.Now().Date - new DateTime(2008,4,1).Date).TotalDays, 5073728, 486035, "45.8169745", "8.82024911", Status.Success),
                    new ConsistentReadingGetDTO(12, 12, 5712, "Ozono", Unit.µg_m3, 138, "MI", "Inzago", true,  (int)(new DateTime(2018,1,1).Date - new DateTime(2001,02,24).Date).TotalDays, 5043030, 538012, "45.53976956", "9.48689669", Status.Success),
                    new ConsistentReadingGetDTO(13, 13, 20488, "Ozono", Unit.µg_m3, 279, "MI", "Erba", false, (int)(SystemTime.Now().Date - new DateTime(2020,10,22).Date).TotalDays, 5072803, 517232, "45.8085738", "9.2217792", Status.Success),
                    new ConsistentReadingGetDTO(14, 14, 10043, "Arsenico", Unit.ng_m3, 215, "VA", "Ferno", false, (int)(SystemTime.Now().Date - new DateTime(2006,11,29).Date).TotalDays, 5051773, 481053, "45.61924753", "8.75697656", Status.Success),
                    new ConsistentReadingGetDTO(15, 15, 6342, "Ossidi di Azoto", Unit.mg_m3, 141, "BS", "Pero", true, (int)(new DateTime(2018,07,30).Date - new DateTime(1986,12,10).Date).TotalDays, 5039595, 507028, "45.50985564", "9.08997419", Status.Success),
                    new ConsistentReadingGetDTO(16, 16, 6665, "Ossidi di Azoto", Unit.mg_m3, 369, "BS", "Cantù", false, (int)(SystemTime.Now().Date - new DateTime(2005,01,17).Date).TotalDays, 5064150, 509783, "45.73083728", "9.12573936", Status.Success),
                    new ConsistentReadingGetDTO(17, 17, 10270, "Ozono", Unit.µg_m3, 221, "MI", "Darfo Boario Terme", true, (int)(new DateTime(2023,07,12).Date - new DateTime(2007,1,1).Date).TotalDays, 5080789, 591371, "45.87460256", "10.17736553", Status.Success),
                    new ConsistentReadingGetDTO(18, 18, 5507, "Biossido di Azoto", Unit.µg_m3, 139, "CO", "Sesto San Giovanni", false, (int)(SystemTime.Now().Date - new DateTime(1980,12,18).Date).TotalDays, 5042386, 518435, "45.53476819", "9.23610903", Status.Success),
                    new ConsistentReadingGetDTO(19, 19, 10035, "Benzene", Unit.µg_m3, 74, "CO", "Cornale", false, (int)(SystemTime.Now().Date - new DateTime(2006,2,2).Date).TotalDays, 4987406, 493238, "45.04008561", "8.91415717", Status.Success),
                    new ConsistentReadingGetDTO(20, 20, 6831, "Ossidi di Azoto", Unit.mg_m3, 180, "BS", "Lonato del Garda", false, (int)(SystemTime.Now().Date - new DateTime(1990,1,1).Date).TotalDays, 5035536, 615762, "45.46375819", "10.48078183", Status.Success)
                },

                new List<OutputFileGetDTO>
                {
                    new OutputFileGetDTO(1, "Readings0_InputFile", bytesOutputText, ".csv", Status.Success),
                    new OutputFileGetDTO(1, "Readings1_InputFile", bytesOutputText, ".csv", Status.Success)
                },
            };
        }
...
1,Sensor Name,ng/m³,1,,1,Province,City,S,{SystemTime.Now().AddYears(-1):dd/MM/yyyy},,1,1,Latitude,Longitude,
1,Sensor Name,ng/m³,1,Station Name,-1,Province,City,S,{SystemTime.Now().AddYears(-1):dd/MM/yyyy},,1,1,Latitude,Longitude,
1,Sensor Name,mg/m³,1,Station Name,1,,City,S,{SystemTime.Now().AddYears(-1):dd/MM/yyyy},,1,1,Latitude,Longitude,
1,Sensor Name,ng/m³,1,Station Name,1,,City,S,{SystemTime.Now().AddYears(-1):dd/MM/yyyy},,1,1,Latitude,Longitude,
1,Sensor Name,mg/m³,1,Station Name,1,Province,,S,{SystemTime.Now().AddYears(-1):dd/MM/yyyy},,1,1,Latitude,Longitude,
...
[ERR] Null or empty latitude.
[ERR] Null or empty longitude.
[ERR] No new Readings have been found!
[ERR] No new Consistent Readings have been found!";

            yield return new object[]
            {
                inputWithErrorsText, expectedErrorsText
            };
        }
    }
}
